...
<p align="center"><strong>The Ray-tracing process:</strong> The ray goes from the camera through a pixels of the window and is tested for intersection with the objects. When a ray hits an object, the ray tracer works out how much light is reflected back along the ray to determine the color of the pixel.</p>
